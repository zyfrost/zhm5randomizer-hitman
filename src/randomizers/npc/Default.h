#ifndef __ZHM5RANDOMIZER_SRC_RANDOMIZERS_NPC_DEFAULT_H__
#define __ZHM5RANDOMIZER_SRC_RANDOMIZERS_NPC_DEFAULT_H__
...
#endif // __ZHM5RANDOMIZER_SRC_RANDOMIZERS_NPC_DEFAULT_H__
